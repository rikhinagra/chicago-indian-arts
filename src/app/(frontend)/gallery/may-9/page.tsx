...
const albums = [
  // Original: { name: "Event Album", credit: "CICA", description: "The official event photo album from the evening." }
  { name: "Photographer Album 1", url: "https://photos.app.goo.gl/LroSCjCMHuAjUVS16" },
  // Original: { name: "Memories in Motion", credit: "Memories in Motion", description: "Beautifully captured moments by the Memories in Motion team." }
  { name: "Photographer Album 2", url: "https://photos.app.goo.gl/WCpD76QdycsD4TUa7" },
  // Original: { name: "Rudy Arias", credit: "Rudy Arias", description: "A unique perspective on the evening through Rudy Arias's lens." }
  { name: "Photographer Album 3", url: "https://photos.app.goo.gl/yHfy4BnftWktrXFZ8" },
  // Original: { name: "Behind the Scenes", credit: "Memories in Motion", description: "Candid behind-the-scenes moments captured by Memories in Motion." }
  { name: "Photographer Album 4", url: "https://photos.app.goo.gl/sLtRHBC7Nz8bEEgW7" },
  // Original: { name: "Videos", credit: "Memories in Motion", description: "Video highlights from the evening by Memories in Motion." }
  { name: "Photographer Album 5", url: "https://photos.app.goo.gl/4rNE71FEPUak5esw6" },
];
...
export default function May9GalleryPage() {
  return (
    <>
      ...
      {/* Albums Section */}
      <section data-section="may9-albums" style={{ paddingTop: "4rem", paddingBottom: "4rem", paddingLeft: "clamp(1rem, 5vw, 4rem)", paddingRight: "clamp(1rem, 5vw, 4rem)", backgroundColor: "#faf8f3" }}>
