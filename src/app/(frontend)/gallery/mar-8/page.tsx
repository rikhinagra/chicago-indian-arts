...
const albums = [
  // Original: { name: "Event Album", credit: "CICA", description: "The official event photo album from International Women's Day." }
  { name: "Photographer Album 1", url: "https://photos.app.goo.gl/gpcoGau62cPKRyXf8" },
  // Original: { name: "Pure Photography", credit: "Pure Photography", description: "Stunning images from the event captured by Pure Photography." }
  { name: "Photographer Album 2", url: "https://photos.app.goo.gl/PDzhT1PHkrXM8TmF8" },
  // Original: { name: "Ashish Behera", credit: "Ashish Behera", description: "A personal and artistic perspective on the evening by Ashish Behera." }
  { name: "Photographer Album 3", url: "https://photos.app.goo.gl/d522QjrvTweBTgdA8" },
];

export default function Mar8GalleryPage() {
  return (
    <>
      {/* Hero Section */}
      <section
        data-section="mar8-hero"
      ...
      >
        ...
        <div className="relative z-10" style={{ maxWidth: "900px", marginLeft: "auto", marginRight: "auto", textAlign: "center" }}>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <SectionTag>March 8, 2026</SectionTag>
            ...
            <p style={{ fontSize: "1.05rem", lineHeight: 1.8, color: "rgba(255,255,255,0.75)", maxWidth: "600px", marginLeft: "auto", marginRight: "auto" }}>
              Explore all photo albums from our International Women&apos;s Day celebration, captured by our talented photographers.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {/* Albums Section */}
      <section data-section="mar8-albums" style={{ paddingTop: "4rem", paddingBottom: "4rem", paddingLeft: "clamp(1rem, 5vw, 4rem)", paddingRight: "clamp(1rem, 5vw, 4rem)", backgroundColor: "#faf8f3" }}>
