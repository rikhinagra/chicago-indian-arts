...
const albums = [
  {
    name: "Event Album",
    description: "The official event photo album from the Zindagi Milegi Na Dobara film screening.",
    url: "https://photos.app.goo.gl/2JngfagbwdTwJzmB9",
    credit: "CICA",
  },
];
...
export default function Feb28GalleryPage() {
  return (
    <>
      ...
      {/* Albums Section */}
      <section data-section="feb28-albums" className="px-6 sm:px-12" style={{ paddingTop: "5rem", paddingBottom: "5rem", backgroundColor: "#faf8f3" }}>
